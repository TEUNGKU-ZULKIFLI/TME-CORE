...
def parse_single_log(log_item: Dict[str, Any]) -> Optional[Dict[str, Any]]:
    ...
    # 1. Regex untuk Login SUKSES (SSH, FTP, API, Winbox, dll.)
    ...
    # 2. Regex untuk Login GAGAL (Brute-Force)
    ...
    # Log lain yang tidak berhubungan dengan login/autentikasi diabaikan
    return None
